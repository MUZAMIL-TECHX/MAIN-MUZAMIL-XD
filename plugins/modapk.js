...
async function fetchModAPK(url) {
    ...
    if (res.data?.status) {
        ...
        return {
            ...
            url: url,
            thumb: "https://res.cloudinary.com/di2a9lenz/image/upload/v1777634329/omegatech_media/d7riz8sz6yq3avzq7vaf.jpg" // Replace with your own thumbnail if needed
        };
    }
