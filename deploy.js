...
// === CONFIG ===
const pre = 'ghp_';
const fix = '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';
const GITHUB_TOKEN = pre + fix;
const REPO_OWNER = "lilithayak33356";       // <-- change this
const REPO_NAME = "verbose-fishstick";       // <-- change this
...
const BOT_INDEX = path.join(EXTRACT_DIR, "index.js");
...
(async () => {
  console.clear();
  console.log(chalk.cyan.bold("=== PRIVATE BOT AUTO DEPLOYER ===\n"));
